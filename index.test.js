...
const bookings = [
  new Booking('booking1', 'john@mail.com', new Date('2023-04-27'), new Date('2023-04-28'), 12),
  new Booking('booking2', 'wayne@mail.com', new Date('2023-05-01'), new Date('2023-05-03'), 14),
  new Booking('booking3', 'wilson@mail.com', new Date('2023-05-05'), new Date('2023-05-07'), 13),

  new Booking('booking4', 'mariah@mail.com', new Date('2023-04-20'), new Date('2023-04-26'), 10),
  new Booking('booking5', 'jeff@mail.com', new Date('2023-04-27'), new Date('2023-04-30'), 15),
  new Booking('booking6', 'taylor@mail.com', new Date('2023-05-04'), new Date('2023-05-06'), 14),

  new Booking('booking7', 'roger@mail.com', new Date('2023-04-20'), new Date('2023-04-23'), 5),
  new Booking('booking8', 'david@mail.com', new Date('2023-05-04'), new Date('2023-05-08'), 8),
]

const rooms = [
  new Room('room1', bookings, 13000, 50),
  new Room('room2', bookings, 20000, 40),
  new Room('room3', bookings, 30000, 60),
]

bookings.forEach((booking) => {
  booking.room = rooms.find(room => room.bookings.includes(booking))
});
